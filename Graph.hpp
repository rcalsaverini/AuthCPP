...
public:
  ...
  //other methods
  int countNodes() { return igraph_vcount(graph); }	// return number of nodes in the graph
  int countEdges() { return igraph_ecount(graph); }	// return number of edges in the graph
